...
(defun create-spacemacs-theme (variant theme-name)
  (let ((class '((class color) (min-colors 89))) ;;                    ~~ Dark ~~                                   ~~ Light ~~
        ...
        (bg1           (if (eq variant 'dark) (if (display-graphic-p) "#1f1f1f" "#262626") (if (display-graphic-p) "#fbf8ef" "#ffffff")))
        (bg2           (if (eq variant 'dark) (if (display-graphic-p) "#1a1a1a" "#1c1c1c") (if (display-graphic-p) "#efeae9" "#e4e4e4")))
        ...
        (comment       (if (eq variant 'dark) (if (display-graphic-p) "#989898" "#2aa198") (if (display-graphic-p) "#2aa198" "#2aa198")))
        (comment-bg    (if (eq variant 'dark) (if (display-graphic-p) "#212121" "#262626") (if (display-graphic-p) "#eff3ea" "#ffffff")))
